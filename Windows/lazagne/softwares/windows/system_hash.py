...
# For more information see powerdump from empire
...
class Hashes(ModuleInfo):
	...
	def launch_powerdump(self):
		# From https://github.com/adaptivethreat/Empire/blob/master/data/module_source/credentials/Invoke-PowerDump.ps1
