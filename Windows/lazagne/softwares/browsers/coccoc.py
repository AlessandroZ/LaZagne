...
class CocCoc(ModuleInfo):
	def __init__(self):
		ModuleInfo.__init__(self, 'coccoc', 'browsers', dpapi_used=True)

	def run(self, software_name=None):
		pwdFound = []
		paths 	 = [
						u'{homedrive}{homepath}\\Local Settings\\Application Data\\CocCoc\\Browser\\User Data'.format(homedrive=constant.profile['HOMEDRIVE'], homepath=constant.profile['HOMEPATH']), 
						u'{localappdata}\\CocCoc\\Browser\\User Data'.format(localappdata=constant.profile['LOCALAPPDATA']), 
					]
